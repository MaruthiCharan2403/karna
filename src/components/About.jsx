...
export default function About() {
    return (
        <div className='flex flex-col justify-start items-center min-h-screen gap-10'>
            <p className='pointer-events-none whitespace-pre-wrap bg-gradient-to-b from-black to-white/100 bg-clip-text text-center text-5xl font-semibold leading-none text-slate-200 mt-17'>ABOUT KARNA</p>
